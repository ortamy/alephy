...
- Name: smoke.spec.js >> checkers module cards >> clicking a module card sets location.hash to its route
- Location: tests\smoke.spec.js:148:3
...
Call log:
  - waiting for locator('.gc-card[href^="#"]') to be visible
          ...
          - generic [ref=e63]:
            - paragraph [ref=e64]:
              - link "АЛЕФИ" [ref=e65] [cursor=pointer]:
                - /url: "#dashboard"
              - text: ·
              - link "Чекеры" [ref=e66] [cursor=pointer]:
                - /url: "#checkers"
            - heading "Чекеры" [level=1] [ref=e67]
            - paragraph [ref=e69]: Проверьте текст на смысловые подмены и сопоставьте формулировку с физикой исходного образа.
          - text: 𐤀
        - generic [ref=e70]: Загрузка модуля…
  - generic "Горячие клавиши" [ref=e73] [cursor=pointer]: ⌨ ?
```
